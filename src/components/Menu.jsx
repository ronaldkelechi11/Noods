...
function MenuItem({ menuitem }) {
    return (
        <div className="w-auto h-80">
            <img src={menuitem.image} className="h-[70%] w-full" />
            <div className="h-[20%] w-full flex flex-col gap-1 p-2 text-center">
                <p className="text-3xl md:text-xl font-billabong">{menuitem.name}</p>
                <p className="text-sm text-slate-400">{menuitem.description}</p>
